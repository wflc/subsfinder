...
def run(subfinder_class):
    parser = argparse.ArgumentParser(prog='subsfinder',
                                     description='A general subsfinder, support custom subsearcher',
                                     epilog=epilog(),
    ...
    parser.add_argument('-c', '--conf', default='~/.subsfinder.json',
    ...
    parser.add_argument('-p', '--pause',
                        action='store_true',
                        help="pause script after subsfinder done. this option is used in 'Context Menu on Windows' only")
    parser.add_argument('-v', '--version',
                        action='version', version='subsfinder {v}'.format(v=__version__),
                        help="show subsfinder's version")
